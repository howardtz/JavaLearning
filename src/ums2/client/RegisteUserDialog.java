...
public class RegisteUserDialog extends JDialog{	
	/**
	 * 
	 */
	private static final long serialVersionUID = 3180416981173494800L;
	...
	public RegisteUserDialog(JFrame parent, String msg) {//注册对话框		
	...
	private class ButtonSaveHandler implements ActionListener{  //保存按钮的事件监听器
		public void actionPerformed(ActionEvent e){
			...
			if(email.length()==0 ){
				...
				if(service.find(email)!=null){  //邮箱已注册
	...
	public RegisteUserDialog(JFrame parent, String msg, User user) { //修改对话框
		super(parent, msg, true);
